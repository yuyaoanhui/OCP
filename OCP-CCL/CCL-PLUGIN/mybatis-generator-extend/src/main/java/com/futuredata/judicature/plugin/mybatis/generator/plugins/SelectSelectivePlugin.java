...
import com.futuredata.judicature.plugin.mybatis.generator.utils.*;
...
public class SelectSelectivePlugin extends BasePlugin {
  ...
  public boolean validate(List<String> warnings) {
    ...
    if (!PluginTools.checkDependencyPlugin(getContext(), ModelColumnPlugin.class)) {
      warnings.add("mybatis:插件" + this.getClass().getTypeName()
          + "插件需配合com.mybatis.mybatis.generator.plugins.ModelColumnPlugin插件使用！");
      return false;
    }
  ...
  public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass,
    ...
    FullyQualifiedJavaType selectiveType = new FullyQualifiedJavaType(
        fullFieldModel.getShortName() + "." + ModelColumnPlugin.ENUM_NAME);

    // 1. selectByExampleSelective 方法
    Method mSelectByExampleSelective = JavaElementGeneratorTools.generateMethod(
        METHOD_SELECT_BY_EXAMPLE_SELECTIVE, JavaVisibility.DEFAULT, listType,
    ...
    Method mSelectByPrimaryKeySelective = JavaElementGeneratorTools.generateMethod(
        METHOD_SELECT_BY_PRIMARY_KEY_SELECTIVE, JavaVisibility.DEFAULT, fullFieldModel);
    ...
    mSelectByPrimaryKeySelective
        .addParameter(new Parameter(selectiveType, "selective", "@Param(\"selective\")", true));
    ...
    if (PluginTools.getPluginConfiguration(context, SelectOneByExamplePlugin.class) != null) {
      Method mSelectOneByExampleSelective = JavaElementGeneratorTools.generateMethod(
          METHOD_SELECT_ONE_BY_EXAMPLE_SELECTIVE, JavaVisibility.DEFAULT, fullFieldModel,
          new Parameter(new FullyQualifiedJavaType(introspectedTable.getExampleType()), "example",
              "@Param(\"example\")"),
          new Parameter(selectiveType, "selective", "@Param(\"selective\")", true));
  ...
  public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
    ...
    selectByExampleSelectiveEle
        .addAttribute(new Attribute("id", METHOD_SELECT_BY_EXAMPLE_SELECTIVE));
    selectByExampleSelectiveEle.addAttribute(new Attribute("resultType",
    ...
    if (stringHasValue(introspectedTable.getSelectByExampleQueryId())) {
      selectByExampleSelectiveEle.addElement(
          new TextElement("'" + introspectedTable.getSelectByExampleQueryId() + "' as QUERYID,"));
    }
    ...
    selectByPrimaryKeySelectiveEle
        .addAttribute(new Attribute("id", METHOD_SELECT_BY_PRIMARY_KEY_SELECTIVE));
    selectByPrimaryKeySelectiveEle.addAttribute(new Attribute("resultType",
        introspectedTable.getRules().calculateAllFieldsClass().getFullyQualifiedName()));
    ...
    if (stringHasValue(introspectedTable.getSelectByExampleQueryId())) {
      selectByPrimaryKeySelectiveEle.addElement(
          new TextElement("'" + introspectedTable.getSelectByExampleQueryId() + "' as QUERYID,"));
    }
    ...
    FormatTools.addElementWithBestPosition(document.getRootElement(),
        selectByPrimaryKeySelectiveEle);
    ...
    if (PluginTools.getPluginConfiguration(context, SelectOneByExamplePlugin.class) != null) {
      ...
      selectOneByExampleSelectiveEle
          .addAttribute(new Attribute("id", METHOD_SELECT_ONE_BY_EXAMPLE_SELECTIVE));
      selectOneByExampleSelectiveEle.addAttribute(new Attribute("resultType",
          introspectedTable.getRules().calculateAllFieldsClass().getFullyQualifiedName()));
      ...
      if (stringHasValue(introspectedTable.getSelectByExampleQueryId())) {
        selectOneByExampleSelectiveEle.addElement(
            new TextElement("'" + introspectedTable.getSelectByExampleQueryId() + "' as QUERYID,"));
      }
      selectOneByExampleSelectiveEle.addElement(columnsEle);
      selectOneByExampleSelectiveEle.addElement(new TextElement(
