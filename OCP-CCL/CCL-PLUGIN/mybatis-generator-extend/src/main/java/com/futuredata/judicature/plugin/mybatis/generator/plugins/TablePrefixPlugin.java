...
public class TablePrefixPlugin extends BasePlugin {
  ...
  public void initialized(IntrospectedTable introspectedTable) {
    ...
    if (this.prefix != null && introspectedTable
        .getTableConfigurationProperty(TableRenamePlugin.PRO_TABLE_OVERRIDE) == null) {
      ...
      try {
        ...
        logger.error("mybatis:插件" + this.getClass().getTypeName() + "使用prefix替换时异常！", e);
      }
    }
  }
}
