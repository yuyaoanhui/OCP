...
/**
 * 
 * {@linkplain org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.AbstractXmlElementGenerator
...
public class XmlElementGeneratorTools {
   ...
   */
  public static Element getSelectKey(IntrospectedColumn introspectedColumn,
  ...
  public static Element getExampleIncludeElement(IntrospectedTable introspectedTable) {
    ...
    includeElement
        .addAttribute(new Attribute("refid", introspectedTable.getExampleWhereClauseId()));
  ...
  public static void useGeneratedKeys(XmlElement element, IntrospectedTable introspectedTable,
    ...
    if (gk != null) {
      IntrospectedColumn introspectedColumn =
          IntrospectedTableTools.safeGetColumn(introspectedTable, gk.getColumn());
   ...
   * @return
   */
  private static List<TextElement> generateCommColumns(List<IntrospectedColumn> columns,
      String prefix, boolean bracket, int type) {
   ...
   * @return
   */
  private static XmlElement generateCommColumnsSelective(List<IntrospectedColumn> columns,
      String prefix, boolean bracket, int type) {
    ...
    for (IntrospectedColumn introspectedColumn : columns) {
      ...
      eleIf.addAttribute(
          new Attribute("test", introspectedColumn.getJavaProperty(prefix) + " != null"));
