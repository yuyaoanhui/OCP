...
public class InnerTypeFullyQualifiedJavaType extends FullyQualifiedJavaType {
  private final static Logger logger =
      LoggerFactory.getLogger(InnerTypeFullyQualifiedJavaType.class);
  ...
  public InnerTypeFullyQualifiedJavaType(String fullTypeSpecification) {
    ...
    try {
      // 修正package
      java.lang.reflect.Field packageName =
          this.getClass().getSuperclass().getDeclaredField("packageName");
