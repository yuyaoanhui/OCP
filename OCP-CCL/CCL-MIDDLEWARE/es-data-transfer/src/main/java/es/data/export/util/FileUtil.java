...
public class FileUtil {
   ...
   */
  public static long readFileByMultiLines(int batchNum, long position,
      FileChannel fcin, ByteBuffer rBuffer, List<String> dataList) {
  ...
  /**
   * 遍历某个文件夹下所有文件，返回文件名称列表。并按照文件名升序。
   * 
   * @author yu.yao
   * @param
   * @return
