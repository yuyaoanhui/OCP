...
public class Judgement {
  ...
  private Map<ParaLabelEnum, List<ParaLabelEnum>> preCondition;
  private Map<ParaLabelEnum, List<Pattern>> labelPatternMap;
  private List<List<ParaLabelBean>> paraLabels;

  public Judgement(Context context) {
