 ...
 *
 */
public final class RabbitException extends Exception {

  private static final Logger logger = LoggerFactory.getLogger(RabbitException.class);
  /**
   * 序列化ID
   */
   ...
   */
  public <T extends ResultCode> RabbitException(String requestId, T resultCode, Object[] args) {
    super(serilizeJson(requestId, resultCode), null, false, true);
    this.requestId = requestId == null ? "null" : requestId;
   ...
   * @param resultCode 错误码
   */
  public <T extends ResultCode> RabbitException(T resultCode) {
