var NAMESPACE_PROCURATORATE_EXAMININGCATCHINGOPINION_交通肇事罪 = {
	/**
	 * point-1:无牌证或已报废
	 */
	info_no_plate : {
	...
	info_accident_responsibility : {
		params : [ {
			tagList : "HANDLE_OPINION#CASE_FACT_EVIDENCE#SOLVE_PROCESS#RISK_ANALYSIS",
			cacheKey : "meta_people_name2obj",
	...
	info_seriously_people : {
		params : [
				{
					tagList : "HANDLE_OPINION#CASE_FACT_EVIDENCE#RISK_ANALYSIS",
					cacheKey : "meta_people_name2obj",
					regex : "(致|造成)[^,，\\.。;；:：、]*?重伤#鉴定[^;；\\.。]*?重伤",
					meanWhile : "0",
					order : "1",
	...
	info_death_toll : {
		params : [ {
			tagList : "HANDLE_OPINION#CASE_FACT_EVIDENCE#RISK_ANALYSIS",
			cacheKey : "meta_people_name2obj",
			regex : "([一二三四五六七八九十两\\d]+)(人|名)[^,，\\.。;；、]*?死亡#死亡[^,，\\.。;；、]*人",
