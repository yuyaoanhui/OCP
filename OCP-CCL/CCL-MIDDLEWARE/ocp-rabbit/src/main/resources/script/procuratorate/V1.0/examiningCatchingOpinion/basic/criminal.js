var NAMESPACE_PROCURATORATE_EXAMININGCATCHINGOPINION_criminal = {
	/**
	 * criminal point-1:主犯
	 */
	...
	info_understanding : {
		params : [
				...
				{
					tagList : "HANDLE_OPINION#QUES_TO_EXPLAIN#RISK_ANALYSIS#CASE_FACT_EVIDENCE",
					cacheKey : "meta_people_name2obj",
					regex : "谅解",
					reverseRegex : "[无未不没劝][^\\.。;；:：]*?(谅解|原谅)|(谅解|原谅)[^\\.。;；:：]*?[无未没]",
					meanWhile : "0",
	...
	info_prepared_offender : {
		params : [ {
			...
			tagList : "HANDLE_OPINION#SOLVE_PROCESS",
			cacheKey : "meta_people_name2obj",
			regex : "(盗窃|犯)(罪)?[（(]?预备|预备[^\\.。;；、]*?(盗窃|犯罪)",
			reverseRegex : "不予认[定可]",
			meanWhile : "0",
		...
		params : [
				{
					...
					tagList : "QUES_TO_EXPLAIN",
					regex : "(老(年)?人|[6-9][0-9]岁|享年[6-9][0-9]|年纪大)"
				} ],
		method : "rule_func_judge_truth_by_regex"
	},
	/**
