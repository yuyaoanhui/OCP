var NAMESPACE_COURT_JUDGEMENT_追索劳动报酬纠纷 = {
	/**
	 * point-1:劳动合同签订
	 */
	 ...
	 * point-9:劳动报酬拖欠时间
	 */
	info_labor_arrear_time : {
		params : [ {
			tagList : "court_opinion#facts_found#facts_found_cmpl",
			regex : "拖欠[^,，\\.。;；、]*(月|年)|(?!主张|支付)[^,，\\.。;；、]*(月|年)[^,，\\.。;；、]*工资",
            reverse : "0",
			unit : "年"
		} ],
		method : "rule_func_extract_time",
		adjust : [ {
			params : [ {
				valueNodes : "0#1#2#4",
				valueRanges : "0-1年#1-2年#2-4年#4年以上"
			} ],
			method : "rule_func_adjust_value_to_range"
		} ]
	},
	 ...
	 * point-10:加班工资计算基数
	 */
	info_overtime_salary_standard : {
		params : [
				{
					tagList : "court_opinion",
					regex : "(合同|协议)[^\\.。,，;；、]*(约定)[^\\.。;；、]*加班(工资|报酬)|加班(工资|报酬)[^\\.。;；、]*(合同|协议)[^\\.。,，;；、]*(约定)",
					capture : "合同约定"
				},
				{
					tagList : "court_opinion",
					regex : "(根据|结合|按|照)[^\\.。,，;；、]*(最低工资标准)[^\\.。;；、]*加班(工资|报酬)|加班(工资|报酬)[^\\.。;；、]*(根据|结合|按|照)[^\\.。,，;；、]*(最低工资标准)",
					capture : "最低工资标准"
				},
				{
					tagList : "court_opinion",
					regex : "(根据|结合|按|照)[^\\.。,，;；、]*(^(?!最低))工资[^\\.。;；、]*加班(工资|报酬)|加班(工资|报酬)[^\\.。;；、]*(根据|结合|按|照)[^\\.。,，;；、]*(^(?!最低))工资",
					capture : "基本工资"
				},
				{
					tagList : "court_opinion",
					regex : "(根据|结合|按|照)[^\\.。,，;；、]*(^(?!最低))工资[^\\.。,，;；、]*(津贴|补助|奖金|绩效)[^\\.。;；、]*加班(工资|报酬)|加班(工资|报酬)[^\\.。;；、]*(根据|结合|按|照)[^\\.。,，;；、]*(^(?!最低))工资[^\\.。,，;；、]*(津贴|补助|奖金|绩效)",
					capture : "基本工资加岗位津贴",
					type : "其他"
				} ],
		method : "rule_func_extract_info_by_regex"
