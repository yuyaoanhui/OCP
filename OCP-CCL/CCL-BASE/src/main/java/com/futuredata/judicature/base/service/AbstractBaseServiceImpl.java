 ...
 *
 */
public abstract class AbstractBaseServiceImpl<T extends BaseModel, TExample> implements
    IBaseService<T, TExample> {
   ...
   */
  @Override
  public boolean modify(T t) throws FdBizException {
    try {
      if (t == null) {
        throw new IllegalArgumentException("参数不能为空!");
      }
   ...
   */
  @Override
  public T queryOne(String id) throws FdBizException {
    // TODO Auto-generated method stub
    return null;
  }
